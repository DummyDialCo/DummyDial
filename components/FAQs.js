...
export default class FAQs extends React.Component {
	...
	render() {
		...
		{'\n'}
		<Text style={Styles.faqTxtParas}>Your phone number will be kept confidential and never shared.</Text>
		{'\n'}
		{'\n'}
		<Text style={Styles.blueTxt}>Why do I have to create a contact using a certain number?</Text>
		{'\n'}
		<Text style={Styles.faqTxtParas}>Dummy Dial uses a custom number to send you calls and texts, you have to save this number into your contacts however you’d like the ID of the caller or sender to appear.</Text>
		{'\n'}
		{'\n'}
		<Text style={Styles.faqTxtParas}>Example: enter the number into your contacts as “Mom” then when recieving a call or text it will appear as though “Mom” contacting you.</Text>
		{'\n'}
		{'\n'}
