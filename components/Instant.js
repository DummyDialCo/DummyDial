...
export default class Instant extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            myMsg: "",
            spinnerStyles: Styles.spinnerHidden
        };
    }
        ...
        return (
            <View style={Styles.all}>
                ...
                <Text style={Styles.steps}>
                    {" "}
                    Instantly receive a call or text{" "}
                </Text>
                ...
                <TouchableOpacity style={Styles.btnM} onPress={()=>{
                    this.setState({ spinnerStyles: Styles.spinner });
                    this.sendCall();
                    setTimeout(()=>{
                        this.setState({ spinnerStyles: Styles.spinnerHidden });
                    }, 10000);
                }}>
                ...
                <View style={this.state.spinnerStyles}>
                    <Text style={{ marginBottom: 15, color: "#5CACEE" }}>
                        Sending...
                    </Text>
